...
describe("ManageEventWizard", () => {
	...
	it("should pass through the submitAction to CreateEventForm", () => {
		...
		expect(CreateEventForm).toHaveBeenCalled();
		expect((CreateEventForm as jest.Mock).mock.calls[0][0]).toMatchObject({
			submitAction,
		});
	});
